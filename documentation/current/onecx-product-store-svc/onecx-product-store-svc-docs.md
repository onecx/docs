...
[Link to Docker registry](https://github.com/onecx/onecx-product-store-svc/pkgs/container/onecx-product-store-svc)
...
[Link to Helm registry](https://github.com/onecx/onecx-product-store-svc/pkgs/container/charts%2Fonecx-product-store-svc)
