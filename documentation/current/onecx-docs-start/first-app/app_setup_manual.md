...
* The `profiles` section specifies which profiles the service can be started with. For further explanation of the profiles see the [onecx-local-env documentation](../../onecx-local-env/index.html).
