...
| |  Details to generating a new OneCX Angular workspace can be found [here](#documentation:onecx-nx-plugins:generator/create-app.adoc). |
| -------------------------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a feature module can be found [here](#documentation:onecx-nx-plugins:generator/create-feature.adoc). |
| ----------------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a search page can be found [here](#documentation:onecx-nx-plugins:generator/create-search.adoc). |
| ------------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a details page can be found [here](#documentation:onecx-nx-plugins:generator/details-page.adoc). |
| ------------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a create-update dialog can be found [here](#documentation:onecx-nx-plugins:generator/create-update-dialog.adoc). |
| ----------------------------------------------------------------------------------------------------------------------------------------- |

The application can now be built, tested and started by running `npm run build`, `npm run test` and `npm start`.

For further customization of the app, you can refer to the general [OneCX App Generator](../../onecx-nx-plugins/index.html) documentation.
