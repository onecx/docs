...
| |  Details to generating a new OneCX Angular workspace can be found [here](../../onecx-nx-plugins/generator/create-app.html). |
| ----------------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a feature module can be found [here](../../onecx-nx-plugins/generator/create-feature.html). |
| -------------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a search page can be found [here](../../onecx-nx-plugins/generator/create-search.html). |
| ---------------------------------------------------------------------------------------------------------------- |
...
| |  Details to generating a create-update dialog can be found [here](../../onecx-nx-plugins/generator/create-update-dialog.html). |
| -------------------------------------------------------------------------------------------------------------------------------- |
