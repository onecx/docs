...
* **loadChildren Behavior** \- The [loadChildren method bound to a Route](https://angular.dev/guide/ngmodules/lazy-loading) is an asynchronous method that in the end should return a module to be displayed when activating a certain Route.
* **Module Loading with Webcomponent** \- With Webcomponent method, the desired Microfrontend’s module is still being loaded using [@angular-architects/module-federation](https://www.npmjs.com/package/@angular-architects/module-federation).
...
* **Reference** \- For a detailed guide on how to expose Microfrontend’s module via Webcomponent method, please refer [here](../../onecx/microfrontend-bootstrapping/module-bootstrapping.html).

## [](#remote-component-behavior)Remote Component Behavior

### [](#%5Foverview%5F2)Overview
...
* **Dynamic Content Creation**The Slot Component content is based on [Angular ViewContainerRef](https://angular.dev/api/core/ViewContainerRef) to dynamically create content inside the Slot Component.
* **Module Loading with Webcomponent** \- With Webcomponent method, the desired Microfrontend’s Remote Component is still being loaded using [@angular-architects/module-federation](https://www.npmjs.com/package/@angular-architects/module-federation).
* **Custom Elements Registration** \- During that loading, it should register a component in the Custom Elements Registry, as mentioned in the previous section.
...
* **Reference** \- For a detailed guide on how to expose Microfrontend’s Remote Components via Webcomponent method, please refer [here](../../onecx/microfrontend-bootstrapping/remote-component-bootstrapping.html).
