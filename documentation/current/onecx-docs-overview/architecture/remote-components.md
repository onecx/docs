...
1. On initial page load, Shell UI gathers Remote Components and Slots data and passes it to a [Topic](../../onecx-portal-ui-libs/libraries/integration-interface.html#topics).
2. Slot Component:  
   1. is rendered within a page.  
   2. reads the data passed down via a [Topic](../../onecx-portal-ui-libs/libraries/integration-interface.html#topics) and fills out its content.  
...
For more information about [Microfrontend content loading](../module-federation/microfrontend-content-loading.html), please refer here.

## [](#useful-resources)Useful Resources

* [Module Federation](https://webpack.js.org/concepts/module-federation/)
* [Microfrontend in Webpack](https://www.angulararchitects.io/en/blog/the-microfrontend-revolution-module-federation-in-webpack-5/)
