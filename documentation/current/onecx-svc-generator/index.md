...
| |  Please note that the generator does not create the database itself. You will need to set up a database separately and configure the connection in your service. The generator will create only the necessary database scripts via [Liquibase](https://www.liquibase.com/) changelogs to set up the required tables and relationships. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
## [](#customize-generation-using-templates)Customize Generation using Templates
