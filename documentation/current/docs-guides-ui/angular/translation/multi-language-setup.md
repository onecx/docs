...
This document contains instructions on how to set up multi-language translations in a [**OneCX compatible**](../app-to-onecx.html) application using the `@ngx-translate` library.
