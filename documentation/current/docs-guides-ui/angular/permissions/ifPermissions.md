...
| |  ifPermission directive requires [User Service](../../../onecx-portal-ui-libs/libraries/angular-integration-interface.html#user-service) to work correctly. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
## [](#disable)`onMissingPermission:'disable'`
