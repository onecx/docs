...
For a practical explanation of stacking behavior, see the [MDN stacking context guide](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Positioned%5Flayout/Stacking%5Fcontext).
...
## [](#angular-compilation)Application is not showing up and "t is not a function" error is in the console
