...
Regardless of whether an application is built with Angular or React, consuming a theme is the same thing: reference the corresponding CSS variable in the application’s own styles, as shown in [Utilizing Theme Variables](#utilizing-theme-variables) below.
...
| \--content-alt-bg-color | Alternate background color of non-text content.        |
...
| \--solid-surface-text-color | Font text color on solid (opaque) surfaces.                                               |
...
| \--topbar-menu-button-text-color   | Color of the text in the vertical menu hiding toggle.                |
...
| \--menu-inline-border-color    | Border color of the inline menu, located in the sidebar (left side of the shell).                   |
