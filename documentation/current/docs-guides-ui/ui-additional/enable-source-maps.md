...
For more information on how to enable source maps in the shell, see [Enable shell source maps](../../onecx-shell/enable-shell-source-maps.html) guide.
...
* [Enable shell source maps](../../onecx-shell/enable-shell-source-maps.html)
