...
[Link to Docker registry](https://github.com/onecx/onecx-test-operator/pkgs/container/onecx-test-operator)
...
onecx.test.scheduler.cron=0 0 0 * * ?
```
...
[Link to Helm registry](https://github.com/onecx/onecx-test-operator/pkgs/container/charts%2Fonecx-test-operator)
