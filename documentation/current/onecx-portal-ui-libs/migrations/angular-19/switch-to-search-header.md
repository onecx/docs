...
| SearchCriteriaComponent | SearchHeaderComponent | Notes                                                                                                     |
| ----------------------- | --------------------- | --------------------------------------------------------------------------------------------------------- |
| searchId                | pageName              | Sets the unique identifier for the search context. Example: app\_object\_search                           |
| disableAdvancedToggle   | \-                    | Deprecated. Use viewMode input instead. Example: viewMode = !disableAdvancedToggle ? 'advanced' : 'basic' |
| criteriaTemplate        | \-                    | Removed criteriaTemplate and create and pass search template inside <ocx-search-header> tag               |

__Table 2\. Output Events__
| SearchCriteriaComponent | SearchHeaderComponent | Notes                                                                         |
| ----------------------- | --------------------- | ----------------------------------------------------------------------------- |
| search                  | searched              | Emits on search action. Provides nothing                                      |
| reset                   | resetted              | Emits on reset action. Provides nothing                                       |
| advancedViewToggle      | viewModeChanged       | Emits on view mode change action. Provides the new view mode Example: 'basic' |
