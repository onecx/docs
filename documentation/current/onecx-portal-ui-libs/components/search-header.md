...
| actions                | [ColumnType](#column-type) | \[\]      | Array of actions available in the header in form of a button or a menu item. Please refer to [PageHeader component](page-header.html) for detailed information. |                                                                |
