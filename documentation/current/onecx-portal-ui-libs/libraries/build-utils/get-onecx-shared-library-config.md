...
## [](#sharedLibraryConfig)Shared Library Configuration
...
### [](#sharedLibraryConfigUsage)Usage Example

#### [](#%5Fangular%5Farchitectsmodule%5Ffederation)@angular-architects/module-federation

For projects using `@angular-architects/module-federation`, set `shouldGenerateSubDeps` to `false`. The `share()` function automatically handles subpackages when `includeSecondaries: true` is set through the [configCallback](#configProperties).
...
#### [](#%5Fmodule%5Ffederationenhanced)@module-federation/enhanced
...
#### [](#%5Fnxangularmodule%5Ffederation)@nx/angular:module-federation
...
#### [](#custom-config-callback)Custom Configuration Callback

Modify the [configuration properties](#configProperties) for packages:
...
#### [](#custom-package-filter)Custom Package Filter
