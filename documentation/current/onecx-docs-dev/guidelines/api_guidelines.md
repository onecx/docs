...
## [](#mandatory-schema-fields)Mandatory Schema Fields
...
| version     | Version of the OpenAPI fileExample: 1.0.0                                                         |
| servers     | {url}:{port} of the application                                                                   |
| tags        | List all used tags like this \- name: {tagName}   description: short description of the purpose   |
...
| tags        | Use camel case for all tags like {tagName}                             |
| ----------- | ---------------------------------------------------------------------- |
...
## [](#dto-naming-convention)DTO Naming Convention
...
| |  Do not include the suffix DTO in your object names. This should and will be added by the generator. If you plan to just return a sub-set of a resource, e.g. as result of an /search endpoint, name your object with the suffix Abstract. Like this for example: ThemeAbstract. |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| |  Do not include 401, 403, 500 errors in OpenAPI files. 401, 403 and 500 are handled by the framework. |
| ------------------------------------------------------------------------------------------------------- |
