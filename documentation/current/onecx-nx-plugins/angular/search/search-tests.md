...
#### [](#example-book-search-component)Example: Book Search Component
...
Replace all occurrences of **changeMe** with **bookTitle** and **CHANGE\_ME** with **BOOK\_TITLE**.
...
#### [](#example-book-effects)Example: Book Effects
...
### [](#search-reducers)Search Reducers
...
#### [](#example-book-reducers)Example: Book Reducers
...
#### [](#example-book-search-selectors)Example: Book Search Selectors
...
![test result search](../../_images/test_result_search.png) 
