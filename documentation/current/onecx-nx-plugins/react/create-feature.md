...
| |  This page documents the React feature generator.For Angular, see [Create a Feature Module](#../generator/create-feature.adoc). |
| --------------------------------------------------------------------------------------------------------------------------------- |
...
Next steps may create components, services, and state management logic within the feature module as needed, e.g. [create a React search page](create-search.html).
