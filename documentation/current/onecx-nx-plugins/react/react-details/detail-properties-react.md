...
| |  This section covers the React implementation. For Angular, see [Configure Detail View (Angular)](../../generator/details/detail-properties.html). |
| ---------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Where **BOOK\_TITLE** and **BOOK\_TYPE** are the translation keys for the additional form fields added in ACTION D1 and D2.
