...
3. Add the corresponding translation keys (see [Search Add-ons](search-add-ons.html)).
4. Map the criteria to the generated API request (see [Map the API](mock-api.html)).
...
| |  Keep the criteria keys in the types file, the field onChange handlers and the translation keys in sync. After adjusting the criteria, continue with mapping them to the API request in [Map the API](mock-api.html). |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
