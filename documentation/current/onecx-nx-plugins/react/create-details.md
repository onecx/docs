...
| |  This page documents the React detail generator.For Angular, see [Create a Detail Component](#../generator/create-details.adoc). |
| ---------------------------------------------------------------------------------------------------------------------------------- |
...
* [Configure Detail Properties (React)](#./react/details/detail-properties-react.adoc)
* [Configure Detail Tests (React)](#./react/details/detail-tests-react.adoc)
