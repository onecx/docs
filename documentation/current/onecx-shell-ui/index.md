...
### [](#shell-version-information)Shell Version Information
...
#### [](#primary-method-about-page)Primary Method: About Page

The preferred method to check shell version information is through the **About page** in the Shell UI. The About page can be accessed by appending `/onecx-shell/about-shell` to your application’s base URL:
...
#### [](#alternative-method-browser-devtools)Alternative Method: Browser DevTools
...
```
4. Expand `default` and `angular-core`
...
![shell version entries](_images/shell_version_entries.png) 

#### [](#angular-libs-version-compatibility)Angular - Libs Version Compatibility
...
| |  The major Angular version in the application determines which OneCX library version should be used. While all versions within the major are compatible, it is **recommended to use the lowest possible OneCX library version** that provides the required features and fixes. |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
The following table outlines the compatibility between OneCX library versions and their corresponding React framework versions:

| OneCX Libs | React |
| ---------- | ----- |
| v8         | 19    |

| |  The major React version in the application determines which OneCX library version should be used. While all versions within the major are compatible, it is **recommended to use the lowest possible OneCX library version** that provides the required features and fixes. |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
