...
After xref:./create_new_angular_app.adoc[creating a new application], we want to run it in our local environment. 
...
* If you used the OneCX generator as outlined in the xref:./create_new_angular_app.adoc[Getting Started guide], you can quickly set up your application using the `onecx-local-env-cli`. See the detailed steps here: xref:./app_setup_cli.adoc[Application Setup using OneCX CLI]
