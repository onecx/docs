...
NOTE: In the same way as for the UI we can also handle the BFF and SVC of our application by using the commands in the xref:./create_new_angular_app.adoc#creating-the-bff[General Getting Started guide].
