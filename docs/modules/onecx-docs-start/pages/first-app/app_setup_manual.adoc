...
* The `profiles` section specifies which profiles the service can be started with. For further explanation of the profiles see the xref:documentation:onecx-local-env:index.adoc[onecx-local-env documentation].
