...
NOTE: For Angular based applications xref:angular-integration-interface.adoc[@onecx/angular-integration-interface] library is available. It is a set of tools aiming to ease the development of Angular applications integrated with OneCX. For more information please refer xref:angular-integration-interface.adoc[here].
