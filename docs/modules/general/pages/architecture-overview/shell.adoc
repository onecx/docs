...
Having data persisted in browser memory via Topics gives Microfrontend's content direct access to information about the workspace and current user. Information passed on by the Shell UI app contains the following information:
