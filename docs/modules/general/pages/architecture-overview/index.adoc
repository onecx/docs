...
* **OneCX App** - An App is a standalone service offering value to the process of managing the data related to an Application [I DON'T REALLY UNDERSTAND THIS SENTENCE, ESP. THE "offering value" PART]. Can be versioned to allow flexibility for the Application's usage. Usually one of the following:
