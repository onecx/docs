...
**example.component.ts** file is prepares the Remote Component for integration with OneCX platform.
...
// bootstrapRemoteComponent
// - creates Application
// - shares ngZone and platform
// - connects router
// - registers component with injector
// -- here injector is not provided, but when application is created new injector is instantiated (check function)
// that way providers are already there when component is instantiated
// providers should have every provider needed for the component
// special APP_INITIALIZER to get correct user's language

Component definition::
// Imports - describe
// - say that for some providers have been prepared
// For angular -> standalone
// SharedModule that has PortalCoreModule.forMicrofrontend() to allow using services and components

Configuration::
// In constructor setting translation language to current users language
// Interfaces for initialization
// point to RemoteComponentConfig
// Explain whats happening
// For other technologies just implement correct method
