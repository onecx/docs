...
The OneCX Hub is your entry point for all content explanations, structures, and guides around OneCX. It consolidates key topics, links to deeper pages, and helps you quickly find the right path.
...
- First Application (overview): {page-path}/first-app/getting_started.adoc[First App]
