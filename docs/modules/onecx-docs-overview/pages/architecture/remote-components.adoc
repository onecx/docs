...
:topic_url: xref:latest@documentation:onecx-portal-ui-libs:libraries/integration-interface.adoc#topics
...
* https://www.angulararchitects.io/en/blog/the-microfrontend-revolution-module-federation-in-webpack-5/[Microfrontend in Webpack]
