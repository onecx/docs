...
:angular-integration-interface_url: xref:documentation:onecx-portal-ui-libs:libraries/angular-integration-interface.adoc
:integration-interface_url: xref:documentation:onecx-portal-ui-libs:libraries/integration-interface.adoc
:topic_url: xref:documentation:onecx-portal-ui-libs:libraries/integration-interface.adoc#topics
...
[#useful-resources]
== Useful Resources
* xref:{page-path}/index.adoc[Architecture Overview]
* xref:{page-path}/mfe.adoc[Microfrontends in OneCX]
* xref:{page-path}/remote-components.adoc[Remote Components in OneCX]
